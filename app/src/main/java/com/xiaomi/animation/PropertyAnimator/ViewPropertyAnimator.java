...
package com.xiaomi.animation.PropertyAnimator;
...
public class ViewPropertyAnimator extends Animator implements AnimatorListener{
    ...
    android.view.ViewPropertyAnimator mViewPropertyAnimator;
    View mTarget;
    ...
    public ViewPropertyAnimator(View target) {
        mTarget = target;
    }
    ...
    public void start() {
        ...
        AnimationUtils.cancelOnDestroyActivity(this);
    }
